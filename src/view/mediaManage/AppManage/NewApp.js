...
export default class NewApp extends React.Component {
	...
	componentWillMount(){
		AppManageStore.getAppCategories();
	}
	submit(){
		...
		if(Client.isAppBao(this.state.packageName)&&this.state.appName!=''&&childId!=''){
			AppManageStore.createApp({appKeyWord:this.state.appKeyWord,
