...
export default class TerritorySetCom extends React.Component {
	constructor(){
		...
		this.state={
			area: area,
			choiceArr:dspManageStore.choiceArr,
			excludeArr:dspManageStore.excludeArr
		}
	}
	componentWillMount(){
		dspManageStore.initChoiceArr=dspManageStore.choiceArr;
		dspManageStore.initExcludeArr=dspManageStore.excludeArr;
	...
	confirm(){
		dspManageStore.choiceArr=this.state.choiceArr;
		dspManageStore.excludeArr=this.state.excludeArr;
		this.props.history.goBack()
	}
	cancel(){
		dspManageStore.choiceArr=dspManageStore.initChoiceArr;
		dspManageStore.excludeArr=dspManageStore.initExcludeArr;
		this.props.history.goBack()
		dspManageStore.initChoiceArr=[];
		dspManageStore.initExcludeArr=[];
	}
	render() {
		return (
			<div>
